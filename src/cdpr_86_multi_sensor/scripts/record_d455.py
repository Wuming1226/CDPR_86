...
def main():
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="Output width. Default: auto-pick max supported color resolution.",
    )
    parser.add_argument(
        "--height",
        type=int,
        default=None,
        help="Output height. Default: auto-pick max supported color resolution.",
    )
    parser.add_argument(
        "--duration",
        type=float,
    ...
    if (args.width is None) != (args.height is None):
        raise ValueError("Please pass both --width and --height, or neither (default max resolution).")

    if args.width is None and args.height is None:
        width, height, fps = _pick_max_color_profile(rs, device, int(args.fps))
        resolution_mode = "max color"
    else:
    ...
    print(
        ...
        f"       resolution: {width}x{height} ({resolution_mode}), fps={fps}\n"
